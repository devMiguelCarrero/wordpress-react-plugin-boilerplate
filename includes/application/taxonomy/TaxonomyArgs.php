<?php
	...
	class WRB_Taxonomy_Labels {

		function __construct() {
			$this->name = __( 'ezt Custom Taxonomy', WRB_DOMAIN );
		    $this->singular_name = __( 'ezt Custom Taxonomy', WRB_DOMAIN );
		    $this->plural_name = __( 'ezt Custom Taxonomies' , WRB_DOMAIN );
		    $this->search_items = '';
		    $this->all_items = '';
		    $this->parent_item = '';
	...
	class WRB_Taxonomy_Labels_Builder extends WRB_Taxonomy_Builder {
