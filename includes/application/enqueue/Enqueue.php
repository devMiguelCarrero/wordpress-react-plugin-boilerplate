<?php
	...
	class WRB_EnqueueBuilder {

		function __construct() {
			$this->enqueue = new WRB_Enqueue();
		}
	...
	require_once( WRB_ACHIEVEMENTS_PATH_ENQUEUE . 'EnqueueVars.php' );
	require_once( WRB_ACHIEVEMENTS_PATH_ENQUEUE . 'styles.php' );
	require_once( WRB_ACHIEVEMENTS_PATH_ENQUEUE . 'scripts.php' );