    ...
    class WRB_SetMenuPages {
        ...
        public function init() {
            ...
            $page->setID('end-tournaments')
                ->setPageTitle( esc_attr__( 'End active tournaments' , WRB_DOMAIN ) )
                ->setMenuTitle( esc_attr__( 'End active tournaments' , WRB_DOMAIN ) )
                ->setMenuSlug( WRB_DOMAIN . '-end-active-tournaments' )
                ->setCallback( 'single_react_view' )
