<?php
    ...
    class WRB_MenuPage {
        ...
        function __construct() {
            ...
            $this->page_title = __( 'Custom Menu Page' , WRB_DOMAIN );
            $this->menu_title = __( 'Custom Menu Page' , WRB_DOMAIN );
            $this->capability = 'manage_options';
            $this->menu_slug = WRB_DOMAIN . '-custom-menu-page';
        ...
        public function single_react_view() {
            WRB_View::get( 'single-react' , [ 'id' => $this->id ] );
        }

    }

    class WRB_MenuPageBuilder {

        function __construct() {
            $this->menu_page = new WRB_MenuPage;
        }
    ...
    require_once WRB_ACHIEVEMENTS_PATH_MENUPAGE . 'set_menu_pages.php';